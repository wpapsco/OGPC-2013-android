...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//tutorial levels
		Map map = new Map(new PointF(375, 350), 0, 1);
		...
		map = new Map(new PointF(400, 500), 3, 3);
		map.addEvent(new EnemiesKilledEvent(false));
		...
		//spine levels
		map = new Map(new PointF(45, 45), R.drawable.level_spine1, getResources(), 4, 23);
		map.addEvent(new EnemiesKilledEvent(false));
		...
		map = new Map(new PointF(105, 530), R.drawable.level_spine2, getResources(), 5, 6);
		...
		map = new Map(new PointF(50, 145), R.drawable.level_spine3, getResources(), 6, 12);
		map.addEvent(new EnemiesKilledEvent(false));
		...
		//brain levels
		map = new Map(new PointF(300, 145), R.drawable.level_brain1, getResources(), 7, 10);
		map.addEvent(new EnemiesKilledEvent(false));
